...
window.wrapperHtml = $('<div class="unobtrusive-flash-message-wrapper"></div>');
window.flashHtml = $('<div class="unobtrusive-flash-message"></div>');
...
(function(){
  ...
  UnobtrusiveFlash.showFlashMessage = function(message, options) {
    ...
    window.flashHtml.html(message);
    var $flash = window.wrapperHtml.addClass('unobtrusive-flash-' + options.type).append(window.flashHtml);
